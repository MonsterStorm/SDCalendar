...
public class CalendarFragment extends DialogFragment {
	 ...
	 */
	protected ArrayList<MonthCalendarGridAdapter> datePagerAdapters = new ArrayList<MonthCalendarGridAdapter>();
	...
	public MonthCalendarGridAdapter getNewDatesGridAdapter(int month, int year) {
		return new MonthCalendarGridAdapter(getActivity(), month, year,
	...
	public void restoreDialogStatesFromKey(FragmentManager manager,
		...
		CalendarFragment existingDialog = (CalendarFragment) manager
	...
	private void setupDateGridPages(View view) {
		...
		// Current month
		MonthCalendarGridAdapter adapter0 = getNewDatesGridAdapter(
		...
		// MonthPagerAdapter
		final ContentPagerAdapter pagerAdapter = new ContentPagerAdapter(
	...
	public class DatePageChangeListener implements OnPageChangeListener {
		...
		private ArrayList<MonthCalendarGridAdapter> caldroidGridAdapters;
		 ...
		 * @return
		 */
		public ArrayList<MonthCalendarGridAdapter> getCaldroidGridAdapters() {
			return caldroidGridAdapters;
		}

		public void setCaldroidGridAdapters(
				ArrayList<MonthCalendarGridAdapter> caldroidGridAdapters) {
		...
		public void refreshAdapters(int position) {
			...
			MonthCalendarGridAdapter currentAdapter = caldroidGridAdapters
					.get(getCurrent(position));
			MonthCalendarGridAdapter prevAdapter = caldroidGridAdapters
					.get(getPrevious(position));
			MonthCalendarGridAdapter nextAdapter = caldroidGridAdapters
